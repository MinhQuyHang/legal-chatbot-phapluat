...
SYSTEM_PROMPT = (
    ...
    "Quy tắc:\n"
    "- Nếu tài liệu có thông tin: bắt đầu bằng 'Theo giáo trình môn học,' và trả lời súc tích.\n"
    "- Nếu tài liệu không có thông tin: trả lời 'Theo giáo trình hiện tại, nội dung này chưa được đề cập.'\n"
    "- Không lặp lại câu hỏi. Không thêm câu hỏi ngược lại. Chỉ văn bản thuần.\n"
    "- Tuyệt đối không sinh ra các dòng có dạng '[Tài liệu …]' hoặc liệt kê lại đoạn tham khảo."
)
...
def build_chatml_prompt(
    ...
    user_prompt = (
        ...
        f"Hãy trả lời bằng lời lẽ tự nhiên, bắt đầu bằng 'Theo giáo trình môn học,'."
    )
    parts.append(f"<|im_start|>user\n{user_prompt}<|im_end|>")
