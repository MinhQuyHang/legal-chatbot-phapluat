...
CHAPTER_KEYWORDS = {
    1:  ["nhà nước là gì", "nguồn gốc nhà nước", "bản chất nhà nước",
         "kiểu nhà nước", "hình thức nhà nước", "chức năng nhà nước"],
    2:  ["bộ máy nhà nước", "quốc hội", "chủ tịch nước", "chính phủ",
         "tòa án", "viện kiểm sát", "hội đồng nhân dân", "ủy ban nhân dân"],
    3:  ["pháp luật là gì", "định nghĩa pháp luật", "khái niệm pháp luật",
         "quy phạm pháp luật", "vi phạm pháp luật", "ý thức pháp luật",
         "quan hệ pháp luật", "trách nhiệm pháp lý", "pháp chế"],
    4:  ["hình thức pháp luật", "tập quán pháp", "tiền lệ pháp", "án lệ",
         "văn bản quy phạm", "hiệu lực pháp luật", "kiểu pháp luật"],
    5:  ["hệ thống pháp luật", "ngành luật", "chế định pháp luật",
         "luật hiến pháp", "pháp điển hóa"],
    6:  ["luật hành chính", "vi phạm hành chính", "xử phạt hành chính",
         "quản lý nhà nước", "chấp hành", "điều hành"],
    7:  ["tội phạm", "hình phạt", "luật hình sự", "trách nhiệm hình sự",
         "tù", "tố tụng hình sự", "bị cáo", "cấu thành tội phạm"],
    8:  ["luật dân sự", "hợp đồng dân sự", "thừa kế", "tài sản",
         "bồi thường thiệt hại", "quyền sở hữu", "pháp nhân"],
    9:  ["luật lao động", "hợp đồng lao động", "tiền lương", "sa thải",
         "người lao động", "người sử dụng lao động", "tranh chấp lao động"],
    10: ["luật hôn nhân", "ly hôn", "kết hôn", "hôn nhân gia đình",
         "vợ", "chồng", "nuôi con", "tài sản vợ chồng"],
}
...
class RAGPipeline:
    ...
    def _route(self, query: str) -> dict:
        ...
        # Keyword override chỉ khi PhoBERT không tự tin tức là nhận vào câu hỏi quá ngắn "Nhà nước là gì?"
        if conf < CONFIDENCE_THRESHOLD:
            ...
            if len(matched_chapters) == 1:
                # Chỉ 1 chapter → scoped
                return {
                    "mode": "scoped",
                    "top_chapters": matched_chapters,
                    "confidence": 0.99,
                    "margin": 0.99
                }
            elif len(matched_chapters) > 1:
                # Nhiều chapter → scoped với cả 2
                return {
                    "mode": "scoped",
                    "top_chapters": matched_chapters,
                    "confidence": 0.99,
    ...
    def answer(self, question: str, top_k: int | None = None, verbose: bool = True) -> dict:
        ...
        if route["confidence"] < 0.1:
            return {
                ...
                "passages": [],
                "rejected": True,
                "message": "Câu hỏi ngoài phạm vi môn Pháp Luật Đại Cương."
            }
